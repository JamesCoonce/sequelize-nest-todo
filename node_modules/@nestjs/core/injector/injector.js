...
class Injector {
    ...
    async loadInstance(wrapper, collection, module) {
        ...
        if (shared_utils_1.isUndefined(targetMetatype)) {
            throw new runtime_exception_1.RuntimeException();
        }
        if (targetMetatype.isResolved) {
            return void 0;
        }
        await this.resolveConstructorParams(wrapper, module, inject, async (instances) => this.instantiateClass(instances, wrapper, targetMetatype, done));
    }
    ...
    async instantiateClass(instances, wrapper, targetMetatype, done) {
