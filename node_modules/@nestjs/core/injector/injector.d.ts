...
export declare class Injector {
    ...
    lookupComponentInExports<T = any>(dependencyContext: InjectorDependencyContext, module: Module, wrapper: InstanceWrapper<T>): Promise<any>;
    lookupComponentInRelatedModules(module: Module, name: any, moduleRegistry?: any[]): any;
    instantiateClass(instances: any[], wrapper: InstanceWrapper<any>, targetMetatype: InstanceWrapper<any>, done: Function): Promise<void>;
}
